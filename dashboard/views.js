...
(()=>{
 ...
 let current=['overview','execution','game','demo'].includes(query.get('view'))?query.get('view'):'overview';
 ...
 function setView(mode){
  ...
  document.title=({overview:'策划网页',execution:'战术执行',game:'独立游戏',demo:'演示导演'})[mode]+' · Deskfront';
 }
 ...
 document.querySelector('#createGameWindow').onclick=()=>{
  ...
  popup=window.open('/?view=game','deskfront-game-'+location.port,'popup=yes,width=1440,height=960,resizable=yes,scrollbars=yes');
