...
顶部 **无尽东线 →**：默认 DeepSeek 慢脑规划 + Laya 本地快脑，支持切换 JEV、游戏 AI、玩家与外部 Agent。绿色远征队向东推进，交战时并行构建右侧下一段，夺点后连续接入，在场世界采用有限窗口回收。南北战场宽度为 2.8 米，东西每段长度从 1.45 米扩大为 **4.35 米（3 倍）**；战壕、守军阵位和旗点同步形成纵深防线。见 [长关卡说明](docs/eastfront/LONG_SECTORS.md)。
