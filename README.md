...
这是可玩的三地图低多边形战术原型，保留概念图的办公室与微型战场构图，不宣称离线写实画质或商业 RTS 的内容规模。Jev 的具体服务协议与凭据尚未提供，交付通用 Agent 接口和可跑示例，**没有假装已接通 Jev**。macOS 构建不签名、不公证。公开仓库：[fangligamedev/deskfront-jevlab](https://github.com/fangligamedev/deskfront-jevlab)。V0.1 保留为此前发布基线，本轮工程版本为0.5.0。
...
版本交付说明见 [资源集成交付报告](docs/DELIVERY-0.5.0.md)。
